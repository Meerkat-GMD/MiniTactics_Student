...
namespace MiniTactics.Lesson03.Tests
{
    ...
    {
        private const string Root = "Assets/Lesson03/";
        ...
        public void ShippedMap_PreservesEveryCellAndSharedTerrain()
        {
            ...
            map.Validate();
            Assert.That(map.Width * map.Height, Is.EqualTo(120));
        ...
        {
            EditorSceneManager.OpenScene(Root + "Scenes/Lesson03.unity", OpenSceneMode.Single);
