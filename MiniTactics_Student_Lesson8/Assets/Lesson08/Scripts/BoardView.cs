...
namespace MiniTactics.Lesson08
{
    ...
    public sealed class BoardView : MonoBehaviour
    {
        ...
        public MovementRangeResult GetMovementRange(Unit selectedUnit)
        {
            ...
            return MovementRange.Calculate(Board, start, selectedUnit.MoveBudget, GetOccupiedCells(selectedUnit));
        }
        ...
        public int GetDefenseBonus(Vector2Int cell)
        {
            return _mapData.GetTile(cell).DefenseBonus;
        }
